    ...
    try {
      ...
      Future<void> _saveTransaction() async {
        ...
        await FirebaseFirestore.instance.collection('transactions').add({
          ...
          // display fields (boleh tetap)
          'date': DateFormat('yyyy-MM-dd').format(selectedDate),
          'time': selectedTime.format(context),
          'note': noteCtrl.text,

          // ✅ ini yang dipakai statistik
          'createdAt': Timestamp.fromDate(combinedDateTime),
        });
        ...
        try {
          await FirebaseFirestore.instance.collection('transactions').add({
            ...
            // tetap simpan yang lama biar kompatibel
            'date': DateFormat('yyyy-MM-dd').format(selectedDate),
            'time': selectedTime.format(context),

            // 🔥 tambah ini biar statistik gampang & akurat
